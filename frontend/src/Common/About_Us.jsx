  ...
  return (
    <div className="lg:mx-[13%] lg:my-[5%] mx-[2%] my-[1%]">
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        labyrinth of finance. Our team of experienced financial experts is ready
        to help not only individuals but also companies make the best financial
        decisions, which will lead to security and prosperity.
      </p>
      <p className="lg:mb-10 mb-5 text-justify">
        We believe that at Trust Financial Advisory, everyone should have access
        to informed financial advice guided by the personal goals and situations
        of that individual. We guide our mission through empowering clients with
        financial advice responsive to values and aspirations. Whether it is
        managing day-to-day finances, providing for a future, or saving for
        retirement, we're here for you to help you reach your goals and succeed.
      </p>
      <p className="lg:mb-10 mb-5 text-justify">
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        experts are here to help you as life evolves so does the market. We are
        your financial advisors but also partners to achieve financial peace of
        mind.
      </p>
      <p className="lg:mb-10 mb-5 text-justify">
