  ...
  return (
    <div className="lg:mx-[13%] lg:my-[5%] mx-[2%] my-[1%]">
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        All information presented on this website is general and intended to be
        used only for informational purposes and should not be regarded as any
        form of financial advice. You acknowledge and agree to the following by
        using this website:
      </p>
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        and data as current and accurate as possible, this should not substitute
        for consultation with a qualified financial advisor familiar with your
        circumstances.
      </p>
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        however guarantee that information provided on this page is up to date,
        accurate, or comprehensive. All liability for misstatements or
      ...
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        interest. Because we neither own nor control the products, services, or
        content found on third-party sites, we make no warranties as to the
        validity of any goods or services purchased from a third party site nor
        do we recommend any third party site.
      </p>
      <h2 className="lg:text-xl text-lg font-semibold text-gray-800 lg:mb-4 lg:mt-7 my-3">
        4. Financial Risks
      </h2>
      <p className="lg:mb-10 mb-5 text-justify">
        ...
        information. Past results are not an assurance of future profitability.
        No financial plan or investment will guarantee a profit.
      </p>
      <h2 className="lg:text-xl text-lg font-semibold text-gray-800 lg:mb-4 lg:mt-7 my-3">
        5. Limitation of Liability
      </h2>
      <p className="lg:mb-10 mb-5 text-justify">
        Trust Financial Advisory shall not be responsible for any cost, damage,
        or loss incurred as a consequence of any usage of this website or
        reliance on any of the information or materials available on it. This
        includes incidental, punitive, consequential, direct, and indirect
        damages.
      </p>
